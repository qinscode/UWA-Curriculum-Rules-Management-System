...
export class UpdateDelete1728544147873 implements MigrationInterface {
    name = 'UpdateDelete1728544147873'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_0023f81631f4d9ab057ad0b487\` ON \`preset-courses\` (\`code\`, \`type\`)`);
    }
