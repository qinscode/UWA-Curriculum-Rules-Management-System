...
export class UpdateEmue1725794828818 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`rules\` ADD \`type\` enum ('English language eligibility requirements', 'Admissions', 'Satisfactory Progress', 'Progress Status', 'Award with distinction', 'Deferrals', 'Additional rules', 'Outcomes & Australian Qualifications Framework', 'Skills', 'Application of knowledge to skills') NOT NULL`);
