...
import AdmissionSelection from '@/components/template-management/RuleSection/AdmissionSelection'
import SatisfactoryProgress from '@/components/template-management/RuleSection/SatisfactoryProgress'
import ProgressStatus from '@/components/template-management/RuleSection/ProgressStatus'
import AwardWithDistinction from '@/components/template-management/RuleSection/AwardWithDistinction'
import Deferrals from '@/components/template-management/RuleSection/Deferrals'
import AdditionalRules from '@/components/template-management/RuleSection/AdditionalRules'
import OutcomesAQF from '@/components/template-management/RuleSection/OutcomesAQF'
...
import ArticulationExitAward from '@/components/template-management/RuleSection/ArticulationExitAward'
import CourseStructure from '@/components/template-management/RuleSection/CourseStructure'
...
const staticCourses: Course[] = [
  { id: '1', type: "Master's (Coursework)", version: '2024' },
  { id: '2', type: "Master's Extended", version: '2024' },
  { id: '3', type: "Master's Research", version: '2024' },
  { id: '4', type: 'Graduate Certificate', version: '2024' },
  { id: '5', type: 'Graduate Diploma', version: '2024' },
  { id: '6', type: 'Doctoral Degree', version: '2024' },
  { id: '7', type: "Professional Doctorate", version: '2024' },
]
...
const ManageRules: React.FC = () => {
  ...
  const handleSaveAsNewVersion = () => {
    if (newVersion) {
      ...
      router.push(`/manage-template?id=${course.id}`)
    }
  }
