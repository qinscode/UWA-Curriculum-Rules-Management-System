...
const filters = {
  postgraduate: ["Master's (Coursework)", "Master's Extended", "Master's Research"],
...
const staticCourses: Course[] = [
  ...
  { id: '7', type: "Professional Doctorate/Master's Coursework", version: '2024' },
]
...
const ChooseTemplate: React.FC = () => {
  ...
  const [filterKey, setFilterKey] = useState<
    'postgraduate' | 'undergraduate' | 'higherdegree' | null
  >(null)
  ...
  const filteredAndSortedCourses = staticCourses.filter(
    (course) =>
            ...
            <Card className="p-4 shadow-md">
              <div className="mb-4">
                <Button
                  ...
                  variant="outline"
                  className={`mb-2 w-full ${filterKey === 'postgraduate' ? 'bg-blue-200' : ''}`}
                >
                  Postgraduate
                </Button>
                <Button
                  ...
                  variant="outline"
                  className={`mb-2 w-full ${filterKey === 'undergraduate' ? 'bg-blue-200' : ''}`}
                >
                  Undergraduate
                </Button>
                <Button
