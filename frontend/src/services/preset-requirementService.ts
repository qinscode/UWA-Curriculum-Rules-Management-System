...
export const requirementService = {
  ...
  getRequirement: async (
    ...
    const res = await fetchWithAuth(
      `${API_URL}/preset-courses/${courseId}/preset-rules/${ruleId}/preset-requirements/${requirementId}`
    )
    return handleResponse(res)
  },
  ...
  addChildRequirement: async (
    ...
    const res = await fetchWithAuth(
      `${API_URL}/preset-courses/${courseId}/preset-rules/${ruleId}/preset-requirements/${parentRequirementId}/children`,
      {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
