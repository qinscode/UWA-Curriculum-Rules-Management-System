...
export async function createRule(rule: Omit<typeof mockRules[0], 'id'>): Promise<typeof mockRules[0]> {
  await new Promise(resolve => setTimeout(resolve, 500));
...
export async function updateRule(id: number, rule: Partial<typeof mockRules[0]>): Promise<typeof mockRules[0]> {
  await new Promise(resolve => setTimeout(resolve, 500));
...
export async function updateSettings(newSettings: Partial<typeof mockSettings>): Promise<typeof mockSettings> {
  await new Promise(resolve => setTimeout(resolve, 500));
